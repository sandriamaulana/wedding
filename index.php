...
<body>
	...
	<div id="page" class="">
		<nav class="fh5co-nav" role="navigation">
			<div class="container">
				...
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="#">A&D<strong>.</strong></a></div>
					</div>
					<div class="col-xs-10 text-right menu-1">
						<ul>
							<li><a href="#" onclick="scroll_to_div('fh5co-event')">Wedding Events</a></li>
							<li><a href="#" onclick="scroll_to_div('lokasi')">Location</a></li>
							<li><a href="#" onclick="scroll_to_div('fh5co-couple-story')">Story</a></li>
							<li><a href="#" onclick="scroll_to_div('gallery')">Gallery</a></li>
						</ul>
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="couple-wrap animate-box">
					<div class="couple-half">
						<div class="groom">
							<img src="images/ahmad.jpg" alt="groom" class="img-responsive">
						</div>
						<div class="desc-groom">
							<h3><strong>Ahmad Zaeni</strong></h3>
					...
					<div class="couple-half">
						<div class="bride">
							<img src="images/eca2.jpg" alt="groom" class="img-responsive">
						</div>
						<div class="desc-bride">
							<h3><strong>Desya Devriani Muchtar Hasanudin</strong></h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,
								there live the blind texts. Separated they live in Bookmarksgrove</p>
						</div>
					</div>
		...
		<div id="fh5co-event" class="fh5co-bg parallax">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
			...
			<div class="container" id="lokasi">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
						...
						<p>Universitas YPKP Sangga Buana, Jl. Phh. Mustofa No.68, Cikutra, Kec. Cibeunying Kidul, Kota Bandung, Jawa Barat 40124</p>
					</div>
				</div>
				<div class="row row-bottom-padded-md">
					<div class="col-md-12">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.9088712880794!2d107.63961511477284!3d-6.901501095013139!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e7bc68e2e737%3A0x194e40758d7a919!2sUniversitas%20Sangga%20Buana%20YPKP!5e0!3m2!1sen!2sid!4v1682667641455!5m2!1sen!2sid" width="100%" height="650" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
					...
					<div class="col-md-12 col-md-offset-0">
						<ul class="timeline animate-box">
							<li class="animate-box">
								<div class="timeline-badge" style="background-image:url(images/ahmadeca.jpg);"></div>
							...
							<li class="animate-box">
								...
								<div class="timeline-panel">
									<div class="timeline-heading">
										<h3 class="timeline-title">A New Journey...</h3>
	...
	<div class="modal" id="demoModal" tabindex="-1" role="dialog" aria-labelledby="demoModal" aria-hidden="true">
		<div class="modal-dialog animated zoomInDown modal-vertical-centered" role="document">
					...
					<div class="row">
						...
						<div class="col-md-12 text-center py-5 px-sm-5 ">
							...
							<?php
								...
								<div style="font-family: Work Sans; font-size: 30px;">Error!</div>
								<div style="font-family: Work Sans; font-size: 40px;"><strong>Silahkan Masukan Nama Undangan</strong> </div>
								<br>
								<form>
									<a href="index.php"><button type="submit" class="btn btn-cstm-dark btn-block btn-cta" aria-label="Close">Close</button></a>
								</form>
								<br>
							<?php } ?>
